              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#08120e] border border-suse-pine/30 rounded-xl px-4 py-3 text-white font-mono focus:outline-none focus:border-suse-pine transition-all"
                  />
                  <p className="text-[10px] text-gray-500 italic px-1">
                    Token is stored locally in your browser to be used for GitHub sync globally.
                  </p>
                </div>
                
                {tokenHistory.length > 0 && (
                  <div className="space-y-3 bg-[#08120e] p-5 rounded-xl border border-white/10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed font-mono">
                    GitHub tokens are exclusively stored locally in your browser's <span className="text-suse-pine">localStorage</span> and used securely for syncing.
                  </p>
                </div>
              </div>
            </div>
